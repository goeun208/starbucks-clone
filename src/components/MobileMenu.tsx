...

                                {
                                    data.map((dropdown_items: MobileDropDownType, first_index: number) => (
                                        <li key={first_index} className='group/gnb'> {/* 첫번째 메뉴 */}
                                            <div className=" flex justify-between items-center border-b border-[#333] px-[1rem] sm:px-[2.2rem]" onClick={() => handleMenuIdx(dropdown_items.title)}>
                                                ...
                                                <div className='text-white  bg-[#181818] w-full'  ref={liRef}>
                                                    <div className='flex flex-col mx-auto' id="mobile_inner_menu_box">
                                                        {dropdown_items.dropDownMenu?.map((menus, menus_idx: number) => (
                                                            <ul key={menus_idx}>
                                                                <div className="flex text-sm xs:text-lg sm:text-[1.5rem] text-white px-[1rem] sm:px-[2.2rem] pr-[1rem] py-5 justify-between items-center" onClick={() => handleInnerMenuIdx(dropdown_items.title, menus.subTitle)}>
