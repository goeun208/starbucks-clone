...
const ReserveBox = () => {
    ...
    return (
        <div className="z-10 min-h-[17vw] relative bg-[url('/images/230125_pc_reserve_bg.jpg')] bg-cover bg-top">
            ...
            <button type="button" className='absolute top-[65%] left-[37.3%] w-[8%] text-white border-2 border-white p-2 rounded-[5px] text-sm hover:animate-whiteButton hover:text-black hover:underline cursor-pointer z-20'>자세히 보기</button>
