    ...
    return (
        <div>
            ...
            <div className="hidden md:block z-10 min-h-[17vw] relative bg-[url('/static/images/230125_pc_reserve_bg.jpg')] bg-cover bg-top">
                ...
                <button type="button" className='absolute top-[65%] left-[37%] w-[7.5%] text-white border-2 border-white py-2 rounded-[5px] text-xs xl:text-sm hover:animate-whiteButton hover:text-black hover:underline cursor-pointer z-20'>자세히 보기</button>
